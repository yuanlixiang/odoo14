...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ensure_db()
        request.params['login_success'] = False  # OrderedDict([('login', u'admin'), ('password', u'admin'), ('redirect', u'')])
        ...
        # 首次登陆 values = OrderedDict([('login_success', False), ('databases', ['odoo14_geely'])])
