...
var config = {
    device: {
        ...
        */
         ...
         */
        SIZES: { XS: 0, VSM: 1, SM: 2, MD: 3, LG: 4, XL: 5, XXL: 6 , XXXL: 7 },
    },
    /**
...
var medias = [
    ...
    window.matchMedia('(min-width: 1200px) and (max-width: 1280px)'),
    window.matchMedia('(min-width: 1281px) and (max-width: 1533px)'),
